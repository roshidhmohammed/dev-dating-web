...
useEffect(()=>{
    ...
    const  saveProfile =async(data)=>{
        ...
        console.log(data)
        await axiosInstance.patch("profle/edit", { firstName:data?.firstName,
            lastName:data?.lastName,
            age:data?.age,
            // profilePic:data?.profilePic,
            gender:data?.gender}, {withCredentials:true})
        .then((res)=>{
...
<RiEditFill className=" text-2xl  text-black  "/>
        ...
        <form className=" mt-5 flex flex-col gap-4" onSubmit={handleSubmit(saveProfile)}>
